...
Source for [criticalengineer.ai](https://criticalengineer.ai) — an essay and a set of working principles about software engineering now that expression is cheap and judgment is not.
...
**Disclosure:** I intend to build tooling to support this way of working — collaborative planning as a first-class object, with status derived from the work rather than reported alongside it. Nothing exists yet. The ideas came first and stand or fall on their own; when there is something to show, it will appear in this organisation, in the open.
...
Text is licensed [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). Quote it, translate it, argue with it; attribution and share-alike apply.
